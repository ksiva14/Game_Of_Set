...
class Cards {
  ...
  print_cards(card_deck) {
    ...
    console.log("recreate - length: " + card_deck.current_deck.length);
  ...
  create_card_img(index, r) {
    ...
    // console.log(card_deck.current_deck[index]);
    // console.log(card_deck.current_deck.length);
    // console.log(curr_card.path);
