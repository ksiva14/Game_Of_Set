...
class Deck {
  ...
  add_to_selected() {
    ...
    // push into array if card is not in the array
    if (card_deck.cards_selected.indexOf(c) == -1) {
      ...
      //remove card if i is inside since the card is clicked twice
      // let index = card_deck.selected_index;
      // console.log(index);
      // card_deck.array_index = card_deck.array_index.splice(index, 1);
      // card_deck.cards_selected = card_deck.cards_selected.splice(index, 1);
    }
  }
}
