...
class Game {
  ...
  // TODO: end the game if this.seconds = 0 && if ends()
  // how to implement? probably check during every click.
  // need to do something to restart the game??? - maybe prevent clicks?
  end_the_game() {
  ...
  change_time() {
    ...
    if (this.seconds < 5) {
      ...
      countdownID.style.fontSize = "150%";
    }
