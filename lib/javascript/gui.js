...
class GUI {
  ...
  add_three_cards() {
    ...
    if (card_deck.deck_of_cards.length != 0) {
      ...
      new Cards().print_cards(card_deck);
    }
  }
  ...
  hide_buttons() {
    //show restart button
    this.restartGameButton.classList.remove("hide");
    // hide game buttons
    for (let i = 0; i < this.hintButtons.length; i++) {
      this.hintButtons[i].classList.add("hide");
    }
    this.add3cardsButton.classList.add("hide");
    this.changePlayerButton.classList.add("hide");
  }
  ...
  unhide_buttons() {
    ...
    // hide game buttons
    for (let i = 0; i < this.hintButtons.length; i++) {
      this.hintButtons[i].classList.remove("hide");
    }
    this.add3cardsButton.classList.remove("hide");
    this.changePlayerButton.classList.remove("hide");
  }
}
