...
// player1.playerDiv.addEventListener("click", () => select(player1));
// player2.playerDiv.addEventListener("click", () => select(player2));
// function select(player) {
//   player.playerDiv.classList.add("selected");
// }
// function deselect(player) {
//   player.playerDiv.classList.remove("selected");
// }
