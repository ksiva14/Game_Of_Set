...
//     @player_name_x = x
//     @player_name_y = y
//     @player_name = Text.new "#{@name}: ", x: @player_name_x, y: @player_name_y, size: 20, color: 'black'
//     @player_score = Text.new @score, x: @player_name_x + 100, y: @player_name_y, size: 20, color: 'black'
//   end
